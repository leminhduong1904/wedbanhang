...
@else
    <li><a href="login"><i class="fa fa-sign-out fa-fw"></i> Đăng Nhap</a>
@endif
...
<li><a href="admin/danhsachloai"><i class="fa fa-dashboard fa-fw"></i>Phân loại
...
<li><a href="admin/danhsachk"><i class="fa fa-users fa-fw"></i>Khách Hàng<span class="fa arrow"></span></a>


<ul class="nav nav-second-level">
<li><a href="admin/danhsachkh">Danh Sách Khách hàng</a></li>
<li><a href="amin/lietkekhachhang">Quản lý đơn hàng</a></li>
</ul><!-- /.nav-second-level -->
</li>
</ul>
