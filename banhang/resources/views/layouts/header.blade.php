<div id="header">
		<div class="header-top">
			...
			@if(Auth::check())			
						<li><a href="dang-xuat"><i class="fa fa-user"></i>{{Auth::user()->full_name}}n</a></li>
			@else			
		...
		<div class="header-body">
			...
			<a href="xoa-gio-hang/{{$pro['item']['id']}}">             <i  class="fa fa-times"></i></a>
				...
				<a class="pull-left" href="#">
					<img src="frontend/image/product/{{$pro['item']['image']}}" alt="{{$pro['item']['image']}}"></a>
										<div class="media-body">
											<span class="cart-item-title">{{$pro['item']['image']}}</span>
			...
			<div class="cart-total text-right">Tổng tiền: 
				<span class="cart-total-value">{{number_format(Session('cart')->totalPrice)}}</span></div>
									<div class="clearfix"></div>
